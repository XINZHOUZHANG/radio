...
const voicePTTStartup = read('ios', 'TX5DRMobile', 'Core', 'RadioLite', 'RadioLiteVoicePTTStartup.swift');
const credentialRefresh = read('ios', 'TX5DRMobile', 'Core', 'RadioLite', 'RadioLiteCredentialRefreshCoordinator.swift');
const operationEpoch = read('ios', 'TX5DRMobile', 'Core', 'RadioLite', 'RadioLiteOperationEpoch.swift');
const credentialStore = read('ios', 'TX5DRMobile', 'Core', 'RadioLite', 'RadioLiteCredentialStore.swift');
